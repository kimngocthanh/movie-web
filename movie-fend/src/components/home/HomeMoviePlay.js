...
function HomeMoviePlay() {
    ...
    const getMovieByName = async () => {
        ...
        const res = await axios.get(`http://localhost:8080/movie-play?username=${ress.sub}&page=${page}`);
    ...
    return (
        <>
            ...
            <section className="popular container" id="popular" style={{ marginTop: '100px' }}>
                ...
                <h4 className="text-center">Danh sách phim đã mua</h4>
